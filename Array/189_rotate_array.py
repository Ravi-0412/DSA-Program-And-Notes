...
# but the following one(2nd one) just changes its reference to a new nums not the value of old nums. it just create a copy of 'nums' and changes the value inside the copied list
