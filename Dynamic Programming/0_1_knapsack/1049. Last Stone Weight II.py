# Indirectly we have to find: 'Minium sum Partition'.
# https://leetcode.com/problems/last-stone-weight-ii/solutions/1725708/similar-to-minimum-subset-sum-difference-aditya-verma-s-style-recursion-memoization-optimized-dp/

# Try to write the code in shorter way reading discussion.(and then modify in every similar Q).
