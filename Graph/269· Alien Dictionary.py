...
class Solution:
    def alienOrder(self, words: List[str]) -> str:
        ...
        for i in range(len(words) - 1):
            ...
            # if word1 is prefix of word2 and word1 is coming before means invalid case, so simply return empty string
        ...
        # False: means we have visited that char as well as its neighbour also before only (in pre cycle)
