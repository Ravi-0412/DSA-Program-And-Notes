...
# Reason for sorting: we have to first start with interval having minimum starting time and after that we have to schedule  next interval with minimum time
...
# isliye sorting starting time ke anusar karenge na ki 'ending time' ke anusar.
