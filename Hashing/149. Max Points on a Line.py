# Same Q as "Hit most balloons" only difference there is no duplicate points i.e no two points having same both 'x' and 'y' coordinate.
# same code as "Hit Most ballons" jsut modified oen line for handling unique points.
