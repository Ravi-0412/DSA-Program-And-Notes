# logic: we can make all array equal in max 'n-1' operation if all ele will be distinct by addition or subtraction operation.

# we can make all ele equal to any ele.
...
# will make all ele to this ele either by 'addition' or subtraction.
