# vvi: only Poistive values solution i.e q :""209. Minimum Size Subarray Sum" won't work since number is "-ve" number also.
...
class Solution:
    def shortestSubarray(self, nums: List[int], k: int) -> int:
        ...
        while j < n + 1:
            ...
            # it means the sum from index 'q[-1]' before curr index 'j' is '-ve'.
