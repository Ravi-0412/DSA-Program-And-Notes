...
# No of subarrays ending with ele at 'i'th index= (i+1). 'i' subarray to which curr ele will get added at last and one singular subarray of arr[i].
# vvi: if we find any previous ele smaller say 'j' than A[i] (j <i) then res[i]= res[j] + (i-j) * arr[i].
