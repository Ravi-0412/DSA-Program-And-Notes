...
# time complexity= O(logn* logn). in worst case we have to traverse logn times(as other side if found full complete binary tree then no need to check further) 
