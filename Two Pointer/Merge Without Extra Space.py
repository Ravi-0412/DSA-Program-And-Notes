...
# after swapping find the proper position of 'first ele at arr2' after swapping using insertion sort technique.
class Solution:
    def merge(self,arr1,arr2,n,m):
        ...
        for i in range(n):
            ...
            # just the insertion sort method to find the proper position.
            k= 1
    ...
    def merge(self,arr1,arr2,n,m):
        ...
        while gap > 0:
            ...
            while j < (n + m):
                ...
                # 2) 'i' pointing to arr1 and j pointing to arr2
                elif i< n and j >= n and arr1[i] > arr2[j - n]:
                    arr1[i], arr2[j - n] = arr2[j - n], arr1[i]
                # 3) both 'i' and 'j' pointing to arr2.
